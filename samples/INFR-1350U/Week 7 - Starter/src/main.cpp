...
void RenderVAO(const Shader::sptr& shader,
...
int main() {
	...
	Texture2DData::sptr thirdMap = Texture2DData::LoadFromFile("images/box.bmp");
	...
	Texture2D::sptr third = Texture2D::Create();
	third->LoadData(thirdMap);
	...
	texture2->Clear(glm::vec4(1.0f)); //white color texture
