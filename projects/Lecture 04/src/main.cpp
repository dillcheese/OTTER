...
int main() {
	...
	//camera
	glm::mat4 View = glm::lookAt(glm::vec3(0, 0, 3),  //cam position
		glm::vec3(0, 0, 0), //cam looks at origin
		glm::vec3(0, 1, 0) //up vector for cam
	);
	...
	// T * R * S  scaling, rotate, transform
	glm::mat4 mvp = Projection * View * Model;  //  <---  right to left
	...
	while (!glfwWindowShouldClose(window)) {
		...
		Model = glm::rotate(Model, glm::radians(rotY), glm::vec3(0.0f, 0.0f, 0.5f));
		Model = glm::translate(Model, glm::vec3(0.0f, -0.5f, 0.0f));
